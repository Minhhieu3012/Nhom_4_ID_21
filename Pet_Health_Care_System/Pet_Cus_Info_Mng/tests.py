...
# from app_admin.models import Customer, Pet, MedicalRecord, Appointment
# # Create your tests here.
# class ViewTestCase(TestCase):
#     def setUp(self):
#         self.client = Client()
#         self.course = Customer.objects.create(name="Test Customer")
#         self.student = Pet.objects.create(name="Test Pet")
#         self.student = MedicalRecord.objects.create(name="Test MedicalRecord")
#         self.student = Appointment.objects.create(name="Test Appointment")
